...
function createEditFormTemplate(event, allDestinations, allOffers) {
  const { dateFrom, dateTo, type, destination, basePrice, offers, isDisabled, isSaving, isDeleting } = event;
...
export default class EditFormView extends AbstractStatefulView {
  ...
  constructor(event, allDestinations, allOffers, onFormSubmit, onEditClick, onDeleteClick) {
    ...
    this.#event = event;
    this._setState(EditFormView.parseTripEventToState(this.#event));
